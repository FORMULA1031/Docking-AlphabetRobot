...
public class LaserRobot_Control : MonoBehaviour
{
    ...
    void Update()
    {
        if (lockon_flag && Player != null)  //プレイヤーをロックオンした場合
        {
            ...
            if (bullet_serialspeed >= 2.5 && transform.position.z > Player.transform.position.z + 3f)
            {
